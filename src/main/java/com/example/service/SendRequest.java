...
public class SendRequest {
     ...
     * source code of api :<a href="https://github.com/goxr3plus/java-google-speech-api
     * /blob/master/src/main/java/com/goxr3plus/speech/synthesiser/Synthesiser.java">...</a>
     *
     ...
     * lấy json dịch.
     *
     * @param from ngôn ngữ ban đầu
     * @param to   ngôn ngữ lúc sau
     * @param text đoạn cần dịch
     * @return xâu mới
